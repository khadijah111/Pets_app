...
// the view, and we change the mPetHasChanged boolean to true.
     ...
     */
    private int mGender = PetsContract.PetsEntry.GENDER_UNKNOWN; // mean= 0;
    ...
    private void savePet() {
        ...
        petValues.put(PetsContract.PetsEntry.COLUMN_PET_NAME, nameString);
        petValues.put(PetsContract.PetsEntry.COLUMN_PET_BREED, breedString);
        petValues.put(PetsContract.PetsEntry.COLUMN_PET_GENDER, genderInteger);
        ...
        petValues.put(PetsContract.PetsEntry.COLUMN_PET_WEIGHT, weight);

        // If the intent DOES NOT contain a pet content URI, then we know that we are
        // creating a new pet -----------INSERT MODE-------------.
        if (mCurrentPetUri == null) {//INSERT new pet
            ...
            //------------------UPDATE MODE -------------------------
            int rowsAffected = getContentResolver().update(mCurrentPetUri, petValues, null, null);
